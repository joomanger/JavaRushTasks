...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            File your_file_name = File.createTempFile("trtr", null);
    ...
    public static class ClassWithStatic {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            prop.put("i", String.valueOf(i));
            prop.put("j", String.valueOf(j));
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            for (String s : prop.stringPropertyNames()) {
                switch (s) {
                    case "i":
                        this.i = Integer.parseInt(prop.getProperty(s));
                        break;
                    case "j":
                        this.j = Integer.parseInt(prop.getProperty(s));
                        break;
                    case "staticString":
                        ClassWithStatic.staticString = prop.getProperty(s);
                        break;
                    default:
                }
            }
